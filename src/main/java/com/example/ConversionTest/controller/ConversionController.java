package com.example.ConversionTest.controller;
...
import com.example.expertisetestoutline.request.CelsiusRequestCon;
import com.example.expertisetestoutline.request.KelvinRequestCon;
import com.example.expertisetestoutline.request.KilometersRequestCon;
import com.example.expertisetestoutline.request.MilesRequestCon;
...
public class ConversionController {
	...
	public float kelvinToCelsius(@RequestBody KelvinRequestCon request) throws NumberFormatException, IOException {
	...
	public float celsiusToKelvin(@RequestBody CelsiusRequestCon request) throws NumberFormatException, IOException {
	...
	public float milesToKilometers(@RequestBody MilesRequestCon request) throws NumberFormatException, IOException {
	...
	public double kilometersToMiles(@RequestBody KilometersRequestCon request) throws NumberFormatException, IOException {
